            ...
            <div className={style.productInfo}>
                ...
                <div className={style.productAddToCartBlock}>
                    <div className={style.productCountSelector}>
                        ...
                        <label className='sr-only' htmlFor="productCountInput">product count</label>
                        <input
                    ...
                    <div>
                        <button className={style.addToCartBtn} onClick={handleAddToCartBtnClick}>
                            <svg className={style.cartIcon} width="22" height="20" viewBox="0 0 20 20" aria-hidden="true">
